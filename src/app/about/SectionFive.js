...
const SectionFive = () => {
  const testimonials = [
    {
      img: "/img/AboutPage/SectionFive/profile01.jpeg",
      text: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.",
      name: "@Hassan Khan",
    },
    {
      img: "/img/AboutPage/SectionFive/profile02.jpeg",
      text: "Great service! I am really impressed with the professionalism.",
      name: "@Ali Ahmed",
    },
    {
      img: "/img/AboutPage/SectionFive/profile03.jpeg",
      text: "Highly recommend them for anyone looking for quality work.",
      name: "@Sara Malik",
    },
    {
      img: "/img/AboutPage/SectionFive/profile04.jpeg",
      text: "The team was incredibly responsive and delivered on time.",
      name: "@Zain Tariq",
    },
    {
      img: "/img/AboutPage/SectionFive/profile05.jpeg",
  ...
  return (
    <div className="section-five w-full h-[60vh] md:min-h-screen flex flex-col justify-center items-center px-4">
      ...
      <div className="w-full max-w-[900px] flex items-center justify-between gap-5">
        ...
        >
          <img src="/img/AboutPage/SectionFive/leftArrow.png" alt="Previous" />
        </button>
        ...
        <button
          ...
          className="w-12 h-12 sm:w-14 sm:h-14 bg-[#5399B6] flex items-center justify-center rounded-lg cursor-pointer hover:opacity-80"
        >
          <img src="/img/AboutPage/SectionFive/rightArrow.png" alt="Next" />
        </button>
      </div>
    </div>
  );
