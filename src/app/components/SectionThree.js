    ...
    return(
        <div className="section-three w-full sm:h-[70vh] md:h-[130vh] bg-[#0A131C]">
            ...
            <div className='flex items-center justify-center flex-wrap sm:relative'>
                <div className='w-[80vw] sm:w-[24vw] md:w-[18vw] h-[20vh] sm:h-[30vh] md:h-[60vh] bg-amber-300 mt-3 sm:absolute sm:top-0 sm:left-[6vw]'>
                    <img className='w-[100%] h-[100%] object-cover' src='/img/SectionThree/image01.jpeg' alt='project one' />
                </div>
                <div className='w-[80vw] sm:w-[28vw] h-[20vh] sm:h-[16vh] md:h-[35vh] bg-amber-300 mt-3 sm:absolute sm:top-0 sm:left-[31%] md:left-[25.5%]'>
                    <img className='w-[100%] h-[100%] object-cover' src='/img/SectionThree/image02.webp' alt='project two' />
                </div>
                <div className='w-[80vw] sm:w-[34vw] md:w-[38.5vw] h-[20vh] sm:h-[30vh] md:h-[60vh] bg-amber-300 mt-3 sm:absolute sm:top-0 sm:right-[6vw]'>
                    <img className='w-[100%] h-[100%] object-cover' src='/img/SectionThree/image03.webp' alt='project three' />
                </div>
                <div className='w-[80vw] sm:w-[24vw] md:w-[18vw] h-[20vh] sm:h-[16vh] md:h-[36vh] bg-amber-300 mt-3 sm:absolute sm:top-[31vh] md:top-[62vh] sm:left-[6vw]'>
                    <img className='w-[100%] h-[100%] object-cover' src='/img/SectionThree/image04.jpeg' alt='project four' />
                </div>
                <div className='w-[80vw] sm:w-[28vw] h-[30vh] md:h-[61vh] bg-amber-300 mt-3 sm:absolute sm:top-[17vh] md:top-[37vh] sm:left-[31%] md:left-[25.5%]'>
                    <img className='w-[100%] h-[100%] object-cover' src='/img/SectionThree/image05.webp' alt='project five' />
                </div>
                <div className='w-[80vw] sm:w-[34vw] md:w-[38.5vw] h-[20vh] sm:h-[16vh] md:h-[36vh] bg-amber-300 mt-3 mb-3 sm:absolute sm:top-[31vh] md:top-[62vh] sm:right-[6vw]'>
