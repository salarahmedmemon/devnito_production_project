            ...
            <div className='flex items-center justify-center flex-wrap sm:relative'>
                <div className='w-[80vw] sm:w-[24vw] md:w-[18vw] h-[20vh] sm:h-[30vh] md:h-[60vh] bg-amber-300 mt-3 overflow-hidden sm:absolute sm:top-0 sm:left-[6vw] cursor-pointer project-one'>
                    ...
                    <div className='overlay opacity-0 text-white flex flex-col items-end text-[.6vw]'>
                        <span className='mt-[10vh] font-bold text-[1vw] pe-[2.5vw]'>Printing Media</span>
                        <p className='pe-[1vw] text-green-400 text-[.7vw]'>Short Detail Here</p>
                        <p className='w-[80%] pt-[4vh] ms-[.8vw] text-[.7vw]'>Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem ipsum has
                            been the industry's standard dummy text ever since the 1500s.
                        </p>
                        <div className='w-[100%] flex items-center justify-between text-[.7vw] mt-[7vh] p-[1vw]'>
                            <a href='#' className='float-left'>Visit Main Link</a>
                            <a href='#' className='float-right'>More Info</a>
                        </div>
                    </div>
                </div>
                <div className='w-[80vw] sm:w-[28vw] h-[20vh] sm:h-[16vh] md:h-[35vh] bg-amber-300 mt-3 sm:absolute sm:top-0 sm:left-[31%] md:left-[25.5%] cursor-pointer project-two'>
                    ...
                    <div className='overlay opacity-0 text-white flex flex-col items-end text-[.6vw]'>
                        <span className='mt-[10vh] font-bold text-[1vw] pe-[2.5vw]'>Printing Media</span>
                        <p className='pe-[1vw] text-green-400 text-[.7vw]'>Short Detail Here</p>
                        <p className='w-[80%] pt-[4vh] me-[1vw] text-[.7vw]'>Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem ipsum has
                            been the industry's standard dummy text ever since the 1500s.
                        </p>
                ...
                <div className='w-[80vw] sm:w-[34vw] md:w-[38.5vw] h-[20vh] sm:h-[30vh] md:h-[60vh] bg-amber-300 mt-3 sm:absolute sm:top-0 sm:right-[6vw] cursor-pointer project-three'>
                    ...
                    <div className='overlay opacity-0 text-white flex flex-col items-end text-[.6vw]'>
                        <span className='mt-[10vh] font-bold text-[2vw] pe-[2.5vw]'>Printing Media</span>
                        <p className='pe-[1vw] text-green-400 text-[1.2vw]'>Short Detail Here</p>
                        <p className='w-[80%] pt-[4vh] me-[1vw] text-[1vw]'>Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem ipsum has
                            been the industry's standard dummy text ever since the 1500s.
                        </p>
                ...
                <div className='w-[80vw] sm:w-[24vw] md:w-[18vw] h-[20vh] sm:h-[16vh] md:h-[36vh] bg-amber-300 mt-3 sm:absolute sm:top-[31vh] md:top-[62vh] sm:left-[6vw] cursor-pointer project-four'>
                    ...
                    <div className='overlay opacity-0 text-white flex flex-col items-end text-[.6vw]'>
                        <span className='mt-[5vh] font-bold text-[1vw] pe-[2.5vw]'>Printing Media</span>
                        <p className='pe-[1vw] text-green-400 text-[.7vw]'>Short Detail Here</p>
                        <p className='w-[80%] pt-[2vh] text-[.7vw]'>Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem ipsum has
                            been the industry's standard dummy text ever since the 1500s.
                        </p>
                ...
                <div className='w-[80vw] sm:w-[34vw] md:w-[38.5vw] h-[20vh] sm:h-[16vh] md:h-[36vh] bg-amber-300 mt-3 mb-3 sm:absolute sm:top-[31vh] md:top-[62vh] sm:right-[6vw] cursor-pointer project-six'>
                    ...
                    <div className='overlay opacity-0 text-white flex flex-col items-end text-[.6vw]'>
                        <span className='mt-[4vh] font-bold text-[1vw] pe-[2.5vw]'>Printing Media</span>
                        <p className='pe-[1vw] text-green-400 text-[.7vw]'>Short Detail Here</p>
                        <p className='w-[75%] pt-[3vh] ms-[1vw] text-[.7vw]'>Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem ipsum has
                            been the industry's standard dummy text ever since the 1500s.
                        </p>
