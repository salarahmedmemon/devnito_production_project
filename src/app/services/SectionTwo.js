  ...
  return (
    ...
    >
      ...
      <div className="h-[10vh] mx-auto" ref={headingRef}>
        <div className="w-[60%] sm:w-[40%] md:w-[24%] mx-auto border-t-4 border-purple-500">
          <h1 className="text-[6vw] sm:text-[4vw] md:text-[2.4vw] text-center">
            Services We Offering
          </h1>
        </div>
        <h2 className="text-[7vw] sm:text-[5vw] md:text-[3vw] text-center text-purple-800 font-semibold">
      ...
      <div className="w-full mt-2 sm:mt-10 md:mt-20 flex flex-col md:flex-row items-center">
        ...
        <div
          ...
          ref={textRef}
        >
          <div className="w-[120%] sm:w-[45%] md:w-[24%] border-l-4 border-purple-500">
            <h1 className="text-[10vw] sm:text-[4vw] md:text-[2.4vw] text-center">
              our services
            </h1>
          </div>
          <p className="text-gray-500 text-center md:text-start mt-4 w-[95vw] sm:w-[90vw] md:w-[56vw] text-[4.2vw] sm:text-[2.4vw] md:text-[1.4vw]">
          ...
          <p className="text-purple-800 font-semibold mt-4 text-center md:text-start w-[90vw] text-[4.2vw] sm:text-[2.4vw] md:text-[1.4vw]">
            Cost-effective and Comprehensive IT Outsourcing Services:
          </p>
          <div className="w-[90vw] md:w-full flex flex-col sm:flex-row mt-4 items-center md:items-start justify-between gap-4 p-4 text-[3.4vw] sm:text-[1.7vw] md:text-[1vw]">
